  ...
  return (
    <div>
      <button
        ...
        className="bg-active-pink rotate-2 rounded-3xl p-7"
      >
            ...
            return (
              ...
              >
                ...
                <div className="flex flex-col ml-5 space-y-3">
                  <span className="poppins text-medium text-white font-medium leading-none">
                    {wallet.title}
                  </span>
                  <span className="text-sm text-white-400 font-light leading-none">
                    {wallet.subtitle}
                  </span>
                </div>
              </div>
