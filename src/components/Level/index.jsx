...
export const Level = ({ isActive, level, price }) => {
  ...
  return (
    <div id={`level-${level}`} className={`px-[60px] sm:px-[70px] h-full flex items-center justify-center rounded-[15px] ${ level % 2 === 1 ? `levels_bg_even ${isActive ? "levels_green_shadow" : ""}` : `levels_bg_uneven ${isActive ? "levels_red_shadow" : ""}`} relative`}>
