  ...
  return (
    <div className="bg-[#151516] h-screen w-full flex flex-col space-y-10 items-center justify-center relative overflow-hidden">
      ...
      <div className="flex flex-col items-center justify-center space-y-1 absolute bottom-3">
        <span className="font-montserrat text-lg text-white sm:text-sm">Time to activate 4 level</span>
        ...
        <img className="absolute bottom-0 z-[1] w-[80%] sm:hidden " src="/green_shadow.png"/> 
        <img  className="hidden sm:block absolute bottom-0 z-[1] sm:w-full  " src="/green_shadowMob.png"/> 
    </div>
  );
}
